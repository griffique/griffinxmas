...
var useSilentSwipeState = function (targetRef, options, onSwipeStart, onSwipeMove, onSwipeEnd) {
    ...
    var _a = (0, useMouseEvents_1.default)(targetRef), onMouseDown = _a.onMouseDown, onMouseMove = _a.onMouseMove, onMouseLeave = _a.onMouseLeave, onMouseUp = _a.onMouseUp;
    var _b = (0, useTouchEvents_1.default)(targetRef), onTouchStart = _b.onTouchStart, onTouchMove = _b.onTouchMove, onTouchEnd = _b.onTouchEnd, onTouchCancel = _b.onTouchCancel;
...
var useSwipeEvents = function (targetRef, options) {
    ...
    if (options === void 0) { options = defaultOptions; }
    var opts = __assign(__assign({}, defaultOptions), (options || {}));
    var _a = (0, useHandlerSetterRef_1.default)(), onSwipeLeft = _a[0], setOnSwipeLeft = _a[1];
    var _b = (0, useHandlerSetterRef_1.default)(), onSwipeRight = _b[0], setOnSwipeRight = _b[1];
    var _c = (0, useHandlerSetterRef_1.default)(), onSwipeUp = _c[0], setOnSwipeUp = _c[1];
    var _d = (0, useHandlerSetterRef_1.default)(), onSwipeDown = _d[0], setOnSwipeDown = _d[1];
    var _e = (0, useHandlerSetterRef_1.default)(), onSwipeStart = _e[0], setOnSwipeStart = _e[1];
    var _f = (0, useHandlerSetterRef_1.default)(), onSwipeMove = _f[0], setOnSwipeMove = _f[1];
    var _g = (0, useHandlerSetterRef_1.default)(), onSwipeEnd = _g[0], setOnSwipeEnd = _g[1];
